...
duration as a collection of points. \note{Usar alguma palavra no
  início do período. Symbols?} \#s, \#d, and \#p are user-defined
...
instance, \code{\#p(0 1)} is expanded to \code{(make-instance 'point
  :x 0 :y 1)}. Finally, \goiaba{} has a few constructor functions
besides the reader macros to help the creation of contour
objects. These functions, \texttt{make-point-list},
