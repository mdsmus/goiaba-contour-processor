...
a pitch contour, density contour, and so on \note{contornos podem ser
  abstraídos}. Contours can be easily recognized from graphic
...
durations are basically ordered collections of cartesian
points. \note{I'm not happy with the following sentence} For instance,
...
\code{(make-instance 'point :x 0 :y 1)}, which is the usual way of
...
composed a woodwind quintet, \textit{Em Torno da Romã}\footnote{Around
  the Pomegranate} based on contour theories operations.
