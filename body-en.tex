...
sets, contours can help to give coherence to a musical piece. They are
...
have been developed to organize in a systematic way current knowledge
...
\note{falta o paragrafo que fala o que o artigo vai ter: ``In this
  paper we will present \goiaba{}, blablabla, and a case study of a
  composition, blablabla (nos falamos disso no \#genos)}
...
contour with duration as \code{\#d(\#p(0 3) \#p(1 1) \#p(2 2) \#p(3
  0))}. The notation \code{\#s(\ldots)} and \code{\#d(\ldots)}
...
figure with the original contour Z, \code{\#s(0 5 3 4 1 3)}, and its
...
The first author of this paper, in his master's\footnote{The reference
  was removed for anonymity and will be added in the final version}
% \cite{sampaio08:em}
